...
const Teacher_Login = () => {
  ...
  useEffect(() => {
    ...
    getToken(messaging, {
      vapidKey:
        "BG_ff9xfhUXwax2eWj-6ikGC2Mm_Mgcygj56YwkgcLZZBC4X_oX25bmroUZLxXsirFjmB5ZUlPYHF1oBYarse_I",
    })
      .then((currentToken) => {
        if (currentToken) {
            ...
            <Box className="outerWrapper">
              ...
              <Box className="LoginForm">
                <FormControl variant="standard" className="FiledsOuter">
                  {/* <div className="input-group loggg_phn">
                    <span className="input-group-text login__phonee">
                      <IoIosPhonePortrait />
                    </span>
                    <span
                      className="input-group-text pink-plus-one plusonecolor"
                    >
                      +1
                    </span>
                    <input
              ...
              <Box>
                <Link to="/teacher-reset-password" className="passLink mt-4">
                  Forgot Password
                </Link>
              </Box>
              ...
              <Typography variant="p" component="p" className="mt-5">
                {" "}
                <p>
                  Don’t have an account yet?{" "}
                  <Link to="/teacher/sign-up" className="AccountName create_account_text">
                    {" "}
                    Create account
                  </Link>
                </p>
