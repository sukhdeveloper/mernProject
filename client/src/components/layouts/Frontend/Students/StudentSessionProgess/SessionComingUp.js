...
import { getUpcomingSessionForStudentDashboard } from "../../../../../actions/frontent";
import { useDispatch } from "react-redux";

const StudentSessionComingUp = () => {
  const [sesssionComingup , setsesssionComingup] = useState()
  const dispatch = useDispatch()

  useEffect(()=>{
    dispatch(getUpcomingSessionForStudentDashboard()).then((res)=>{
      console.log(res,'res')
...
export default StudentSessionComingUp;
